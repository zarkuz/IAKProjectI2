...
public class BukuAdapter$BukuHolder_ViewBinding implements Unbinder {
  private BukuAdapter.BukuHolder target;

  @UiThread
  public BukuAdapter$BukuHolder_ViewBinding(BukuAdapter.BukuHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    BukuAdapter.BukuHolder target = this.target;
